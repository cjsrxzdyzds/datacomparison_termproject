...
\begin{figure}[h]
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \Description{Histogram showing high frequency for lowercase letters and space character.}
    \end{minipage}
    \hfill
    \begin{minipage}{0.48\textwidth}
        \centering
        ...
        \Description{Histogram showing sparse distribution with spikes at 0 and control characters.}
    \end{minipage}
...
\begin{figure}[ht]
    ...
    \Description{Line graph showing entropy fluctuating between 4 and 5 bits per symbol.}
    \label{fig:ent_alice}
\end{figure}
...
\begin{figure}[ht]
    ...
    \Description{Line graph showing entropy dropping to near zero in multiple regions.}
...
\begin{figure}[ht]
    ...
    \Description{Comparison plot showing two images and their histograms. Desert histogram is concentrated, Sky histogram is flatter.}
