...
The encoding process converts a sequence of symbols into a single binary fraction within the unit interval.
...
2 & A & $[0.2, 0.44)$ & - & - \\ \hline
2a & - & $[0.4, 0.88)$ & E1 Scaling & 0 \\ \hline
\end{tabular}
...
To leverage the complementary strengths of different models, we implemented a \textbf{Context Mixing} strategy~\cite{mahoney2005adaptive}. This meta-model combines the probability estimates of multiple sub-models (e.g., Markov and FSM) to produce a final prediction.
\begin{itemize}
...
\begin{itemize}
    \item \textbf{Arithmetic Coding}: Implemented using double-precision floating-point arithmetic with renormalization (E1, E2, E3 scaling) as described by Witten et al.~\cite{witten1987arithmetic} to maintain numerical stability.
