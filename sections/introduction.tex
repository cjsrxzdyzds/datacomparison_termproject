...
\begin{itemize}
    \item A unified MATLAB implementation framework for comparing diverse probability models with arithmetic coding
    \item A custom implementation of a Long Short-Term Memory (LSTM) network for symbol prediction
    \item Comprehensive empirical evaluation across Text, Binary, and DNA datasets
    \item Quantitative analysis of the compression-complexity trade-off, highlighting the performance of sparse Markov models versus neural approaches
\end{itemize}
